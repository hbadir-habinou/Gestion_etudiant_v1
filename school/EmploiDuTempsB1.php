...
$query = "SELECT * FROM emploi_b1 ORDER BY id DESC LIMIT 1";
...
<head>
    ...
    <title>Emploi du temps B1 - CampusFlow</title>
        ...
        <div class="timetable-card">
            <div class="timetable-header">
                ...
                <div>
                    ...
                    <button class="btn-new" onclick="window.location.href='ajouter_emploi.php?classe=B1'">
                        Nouveau planning
                    </button>
                </div>
            </div>

...
$query = "SELECT * FROM emploi_b2 ORDER BY id DESC LIMIT 1";
...
<head>
    ...
    <title>Emploi du temps B2 - CampusFlow</title>
        ...
        <div class="timetable-card">
            <div class="timetable-header">
                ...
                <div>
                    ...
                    <button class="btn-new" onclick="window.location.href='ajouter_emploi.php?classe=B2'">
                        Nouveau planning
                    </button>
                </div>
            </div>

...
<body>
    ...
    <nav class="sidebar">
        <div class="admin-profile">
            <img src="images_pages/administrateur.png" alt="Admin" class="admin-avatar">
    ...
    <main class="main-content">
        <h1>Liste des Enseignants et Matières</h1>
        <div class="search-card">
            <select id="search-column">
                ...
                <option value="nb_seance">Séances restantes</option>
            </select>
            <input type="text" id="search-value" placeholder="Rechercher..." onkeyup="filterTable()">
        </div>
        <div class="table-card">
            <div class="add-button-container">
                <button class="btn-add" onclick="window.location.href='ajouter_matiere.php'">Ajouter une Attribution</button>
            </div>
            <table>
                <thead>
                    <tr>

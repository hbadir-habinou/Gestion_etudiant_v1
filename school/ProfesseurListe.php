    ...
    <main class="main-content">
        ...
        <div class="table-card">
            <div class="add-button-container">
                <button class="btn-add" onclick="window.location.href='ajouter_professeur.php'">
                    Ajouter un Professeur
                </button>
            </div>
            <table id="professeur-table">
                ...
                <tbody id="professeur-table-body">
                    ...
                    ?>
                            <tr class="dark-border">
                                ...
                                <td>
                                    <img src='photos_enseignant/<?php echo $image_path; ?>' alt='Photo'>
                                </td>
                                <td><?php echo $NomPrenom; ?></td>
                                <td><?php echo $adresse_mail; ?></td>
                                <td><?php echo $date_naissance; ?></td>
                                <td class="action-buttons">
                                    <button class="btn-edit" onclick="window.location.href='modifier_professeur.php?id=<?php echo $id; ?>'">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    <button class="btn-delete" onclick="if(confirm('Êtes-vous sûr de vouloir supprimer ce professeur?')) window.location.href='supprimer_professeur.php?id=<?php echo $id; ?>'">
                                        <i class="bi bi-trash"></i>
                                    </button>
                                    <button class="btn-info" onclick="showProfesseurDetails(
                                        '<?php echo $id; ?>',
                                        '<?php echo $matricule_enseignant; ?>',
                                        '<?php echo $image_path; ?>',
                                        '<?php echo $NomPrenom; ?>',
                        ...
                        response.records.forEach(record => {
                            output += `
                                <tr class="dark-border">
                                    ...
                                    <td><img src='photos_enseignant/${record.image_path}' alt='Photo'></td>
                                    <td>${record.NomPrenom}</td>
                                    <td>${record.adresse_mail}</td>
                                    <td>${record.date_naissance}</td>
                                    <td class="action-buttons">
                                        <button class="btn-edit" onclick="window.location.href='modifier_professeur.php?id=${record.id}'">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                        <button class="btn-delete" onclick="if(confirm('Êtes-vous sûr de vouloir supprimer ce professeur?')) window.location.href='supprimer_professeur.php?id=${record.id}'">
                                            <i class="bi bi-trash"></i>
                                        </button>
                                        <button class="btn-info" onclick="showProfesseurDetails(
                                            '${record.id}',

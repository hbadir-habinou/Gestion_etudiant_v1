    ...
    <main class="main-content">
        ...
        <div class="table-card">
            <div class="add-button-container">
                <button class="btn-add" onclick="window.location.href='versement.php'">
                    Ajouter un Versement
                </button>
            </div>
            <table id="versement-table">
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="action-buttons">
                                    ...
                                    <button class="btn btn-delete" onclick="deleteVersement(<?php echo $id; ?>)">
                                        Supprimer
                                    </button>
                                </td>
                            </tr>
                            ...
                            output += `
                                <tr>
                                    ...
                                    <td class="action-buttons">
                                        ...
                                        <button class="btn btn-delete" onclick="deleteVersement(${record.id})">
                                            Supprimer
                                        </button>
                                    </td>
                                </tr>

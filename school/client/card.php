    ...
    <div class="card-container">
        <div class="student-card">
            ...
            <h2 class="text-center mb-4">
                <i class="fas fa-id-card me-2"></i>Carte de l'étudiant
            </h2>

            <img src="../photos/<?php echo $studentInfo['image_path']; ?>" alt="Image de l'étudiant" class="profile-image">
            ...
            <form method="POST" action="" class="text-center mt-4">
                <button type="submit" name="export" class="btn btn-custom">
                    <i class="fas fa-download me-2"></i>Exporter la carte d'étudiant
                </button>
            </form>
        </div>
    </div>

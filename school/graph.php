...
$insolvent_query = "SELECT COUNT(*) FROM etudiant_infos WHERE solvabilite = 'INSOLVABLE'";
...
$insolvent_count = $db->query($insolvent_query)->fetchColumn();
...
<head>
    ...
    <style>
        ...
        /* Conteneur flexible pour les cartes */
        .cards-container {
            display: flex;
            gap: 20px; /* Espace entre les cartes */
            justify-content: space-between; /* Aligner les cartes côte à côte */
        }
...
<body>
    ...
    <script>
        ...
        const insolventCount = <?php echo $insolvent_count; ?>;
        ...
        const solvabilityData = {
            ...
            datasets: [{
                ...
                data: [solvableCount, insolventCount, inProgressCount],
                backgroundColor: [
                    'rgba(75, 192, 192, 0.6)',
                    'rgba(255, 99, 132, 0.6)',
                    'rgba(255, 206, 86, 0.6)'

...
<head>
    ...
    <title>Notes B3 - CampusFlow</title>
...
<body>
    ...
    <main class="main-content">
        <h1>Notes des étudiants de la classe B3</h1>
        <div class="table-card">
            <?php foreach ($classes as $classe): ?>
                <?php if (isset($notes[$classe]) && !empty($notes[$classe])): ?>
                    <h2>Notes des étudiants de la classe <?php echo $classe; ?></h2>
                    <button class="btn-add" onclick="window.location.href='envoyer_notes.php?classe=<?php echo $classe; ?>'">Envoyer les notes</button>
                    <button class="btn-add" onclick="window.location.href='envoyer_conseils.php?classe=<?php echo $classe; ?>'">Envoyer des conseils d'orientation</button>
